...
import { Users, Ruler, List, UserPlus } from "lucide-react";
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Sistema de cadastro de pacientes e medições cranianas com cálculos automáticos de índices</p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {menuItems.map((item, index) => {
          const Icon = item.icon;
          return <Card key={index} className="hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 cursor-pointer" onClick={() => navigate(item.path)}>
